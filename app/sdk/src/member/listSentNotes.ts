...
const listSentNotes = async ({ member, community }: MemberReaderProps) => {
  const program = getProgram();
  let sentNotes;
  try {
    sentNotes = await program.provider.connection.getProgramAccounts(
      program.programId,
      {
